...
import { View, Text, StyleSheet, TouchableOpacity, Animated, Easing, ScrollView, TextInput, Dimensions, TouchableWithoutFeedback, PanResponder, KeyboardAvoidingView, Platform, Keyboard } from 'react-native';
          ...
          <View style={{ flex: 1, overflow: 'hidden', marginHorizontal: 16, borderRadius: 16, marginBottom: 16, backgroundColor: colors.surface }}>
            ...
            <WebView 
              ...
              injectedJavaScript={isDesktopMode ? `
                ...
                // Request a tiny initial scale, OS will automatically clamp it to perfectly fit the screen width
